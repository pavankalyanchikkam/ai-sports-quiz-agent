...
- Generates 3 strictly grounded multiple-choice questions via OpenAI (GPT-3.5-Turbo).
- Interactive, state-managed UI with color-coded answer reveals.

## Setup Instructions
1. Install dependencies: `pip install -r requirements.txt`
2. Create a `.env` file and add your API key: `OPENAI_API_KEY=sk-your_key_here`
